    ...
    <div class="card">
        {{-- <div class="row mb-2">
            <div class="col-sm-12">
                ...
                <table
                    class="table table-bordered table-striped table-hover ajaxTable datatable datatable-projectSource">
                    <thead>
                        <tr>
                            <th width="10">
                            </th>
                                        ...
                                        @if (!auth()->user()->is_client)
                                            ...
                                            <div class="form-group mr-1 mb-1">
                                                <button type="button" class="btn btn-danger btn-sm mb-1"
                                                    data-toggle="modal" data-target="#deleteModal_{{ $source->id }}">
                                                    Delete
                                                </button>
                                                <!-- Delete Confirmation Modal -->
                                                <div class="modal fade" id="deleteModal_{{ $source->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="deleteModalLabel_{{ $source->id }}"
                                                    aria-hidden="true">

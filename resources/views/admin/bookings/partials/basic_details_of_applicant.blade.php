@includeIf('admin.bookings.partials.common_details_of_applicant')
@if(!empty($lead))
...
<div class="col-md-6">
    <div class="form-group">
        <label for="lead_details_Son">
            Son/of
        </label>
        <input type="text" name="lead_details[son_of]" id="lead_details_Son_of" value="@if(!empty($lead) && !empty($lead->lead_info['son_of'])) {{$lead->lead_info['son_of']}} @endif" class="form-control">
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        <label for="lead_details_Daughter">
            Daughter/of
        </label>
        <input type="text" name="lead_details[daughter_of]" id="lead_details_Daughter_of" value="@if(!empty($lead) && !empty($lead->lead_info['daughter_of'])) {{$lead->lead_info['daughter_of']}} @endif" class="form-control">
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        <label for="lead_details_Wife">
            Wife/of
        </label>
        <input type="text" name="lead_details[wife_of]" id="lead_details_Wife_of" value="@if(!empty($lead) && !empty($lead->lead_info['wife_of'])) {{$lead->lead_info['wife_of']}} @endif" class="form-control">
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">

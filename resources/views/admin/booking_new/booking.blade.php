                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <select name="advance_amount[][credit_not_credit]" id="credit_not_credit" class="form-control">
                                        <option value="">@lang('messages.please_select')</option>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function setupEventListeners() {
            var paymentMode = document.querySelectorAll('.payment-container select[name^="advance_amount["][name$="][payment_mode]"]');
